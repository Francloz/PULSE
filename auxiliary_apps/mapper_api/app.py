...
import torch
from category_aware_mapper import BioBERTEntityLinker  # Replace with actual path or inline class if needed
...
def link_mentions():
    ...
    for mention in mentions:
        try:
            candidates = linker.link(mention["text"], mention["tag"])
